...
<script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
 <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA3AXrKfBlFRHT0ndSXt4wT-MtDtGy8jGA&callback=initMap&libraries=&v=weekly"
      async
    ></script>
...
not.push([<?php echo "'Açıklama:".$kordinat[$i][8]."'"; ?>]);
